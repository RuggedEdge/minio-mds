...
export const lightColors = {
  white: "#fff",
  sectionOneBG: "#fff",
  defaultFontColor: "#231F20",
  bulletColor: "#231F20",
  borderColor: "#231F20",
  boxBackground: "#ECEFE6",
  mainGrey: "#5B5C5C",
  disabledGrey: "#231F20",
  hoverGrey: "#231F20",
  pressedGrey: "#231F20",
  actionDisabledGrey: "#231F20",
  mainBlue: "#ECEFE6",
  hoverBlue: "#ECEFE6",
  pressedBlue: "#ECEFE6",
  mainRed: "#C51B3F",
  ...
  labelColor: "#231F20",
  mainGreen: "#4CCB92",
  checkBoxBorder: "#231F20",
  iconButtonBG: "#B8C698",
  iconButtonActive: "#839E64",
  iconButtonHover: "#839E64",
  iconButtonDisabled: "#231F20",
  iconButtonColor: "#231F20",
  ...
  mainOrange: "#FFBD62",
  menuBackground: "#B8C698",
  menuDropArrowColor: "#8399AB",
  menuDropArrowBackground: "#0A1C3C",
  menuSelectedOption: "#839E64",
  menuCommonColor: "#CADAE8",
  menuColorDivider: "#231F20",
  menuCollapseColor: "#B8C698",
  menuIconBG: "#3E6549",
  menuIconBorder: "#231F20",
  tabBorder: "#231F20",
